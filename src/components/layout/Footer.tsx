          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="text-sm font-medium text-white/48 transition-colors hover:text-green-300"
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-white/48 transition-colors hover:text-green-300"
                  >
                    {link.label}
                  </Link>
                </li>
