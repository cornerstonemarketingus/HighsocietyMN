      ...
      {variants.length > 0 && (
        <label className="block text-sm font-semibold text-slate-800">
          ...
          <select
            ...
            className="mt-2 w-full rounded-xl border border-slate-300 bg-white px-4 py-3 font-normal text-slate-900 outline-none focus:border-green-500"
          >
      ...
      {requiredFields.map((field) => (
        <label key={field.title} className="block text-sm font-semibold text-slate-800">
          ...
          <textarea
            ...
            className="mt-2 w-full resize-y rounded-xl border border-slate-300 px-4 py-3 font-normal outline-none focus:border-green-500"
          />
        </label>
      ))}
      {selectedVariant && (
