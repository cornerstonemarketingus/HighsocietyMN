    ...
    <div className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <main className="mx-auto max-w-4xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm sm:p-10">
          ...
          <div className="mt-10 space-y-9 [&_a]:font-medium [&_a]:text-orange-700 [&_a]:underline [&_h2]:text-2xl [&_h2]:font-semibold [&_li]:leading-7 [&_p]:leading-7 [&_p]:text-slate-700 [&_ul]:list-disc [&_ul]:space-y-2 [&_ul]:pl-6">
            {children}
          </div>
        </div>
      </main>
