    ...
    return (
      <div className="space-y-3 rounded-2xl bg-white/[.055] p-6 text-center shadow-[inset_0_1px_0_rgba(255,255,255,.1)] backdrop-blur-[30px]">
        ...
        <div className="rounded-xl bg-black/25 px-6 py-3 shadow-[inset_0_1px_0_rgba(255,255,255,.08)]">
          <p className="font-mono text-2xl font-bold tracking-widest text-green-300">{code}</p>
        </div>
    ...
    <div className="space-y-4 rounded-2xl bg-white/[.045] p-6 shadow-[inset_0_1px_0_rgba(255,255,255,.08)] backdrop-blur-[30px]">
      ...
      <form onSubmit={handleSubmit} className="flex gap-2">
        <input
          ...
          required
          className="min-w-0 flex-1 rounded-xl bg-white/[.07] px-4 py-2.5 text-sm text-white shadow-[inset_0_1px_0_rgba(255,255,255,.09)] outline-none placeholder:text-white/30 focus:ring-2 focus:ring-green-300/40"
        />
        <button
          type="submit"
          disabled={loading}
          className="flex items-center gap-2 rounded-xl bg-white px-5 py-2.5 text-sm font-semibold text-[#050505] transition-colors hover:bg-green-50 disabled:opacity-50"
        >
