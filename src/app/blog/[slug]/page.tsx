  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
        ...
        {!post.image && (
          <div className="w-full h-40 rounded-2xl mb-8 bg-gradient-to-br from-green-900/30 to-black/60 flex items-center justify-center">
            <BookOpen className="h-14 w-14 text-green-800" />
          </div>
        )}
        ...
        {post.excerpt && (
          <p className="text-slate-600 text-lg mb-8 border-l-2 border-green-500 pl-4">
            {post.excerpt}
          </p>
        )}
