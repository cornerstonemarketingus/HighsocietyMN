      ...
      <main className="relative">
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
          <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div className="space-y-3">
              <p className="text-xs font-semibold uppercase tracking-[0.32em] text-orange-300/80">The collection</p>
            ...
            <Link href="/products" className="inline-flex items-center gap-2 text-sm font-medium text-orange-300 transition-colors hover:text-white">
              Shop everything <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            {categories.map((category) => (
              <Link
                ...
                className="glass-card group relative min-h-72 overflow-hidden rounded-[1.75rem] transition-all duration-500 hover:-translate-y-1.5 hover:shadow-[0_28px_90px_rgba(255,145,0,.16)]"
              >
                ...
                <div className="absolute inset-x-0 bottom-0 h-24 bg-[radial-gradient(ellipse_at_bottom,rgba(255,145,0,.18),transparent_68%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-4 pb-8 sm:px-6 lg:px-8">
          <div className="glass-panel relative overflow-hidden rounded-[1.75rem] px-6 py-6 sm:px-8">
            <div className="pointer-events-none absolute -left-20 -top-24 h-48 w-48 rounded-full bg-amber-400/20 blur-[70px]" />
            <div className="pointer-events-none absolute -right-20 -bottom-24 h-52 w-52 rounded-full bg-orange-400/20 blur-[75px]" />
            <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              <div className="flex items-start gap-4">
                <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-white/[.07] text-orange-300 shadow-[inset_0_1px_0_rgba(255,255,255,.12)] backdrop-blur-[30px]">
                  <Zap className="h-7 w-7" />
                </div>
                <div className="space-y-2">
                  <p className="text-sm uppercase tracking-[0.35em] text-amber-300/70">Next drop</p>
            ...
            {trustItems.map((item) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-white/[.06] text-orange-300">
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="glass-panel relative grid gap-8 overflow-hidden rounded-[2rem] p-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:p-12">
            <div className="pointer-events-none absolute -right-20 -top-28 h-80 w-80 rounded-full bg-orange-500/20 blur-[110px]" />
            <div className="pointer-events-none absolute bottom-[-8rem] left-[30%] h-64 w-64 rounded-full bg-orange-400/14 blur-[100px]" />
            <div className="min-w-0 space-y-5">
              <p className="text-xs font-semibold uppercase tracking-[0.32em] text-orange-300/80">This week</p>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={item} className="flex items-start gap-3 text-white/68">
                    <Star className="mt-0.5 h-5 w-5 shrink-0 text-orange-300" />
                    <span>{item}</span>
                  </div>
                ))}
              </div>
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="mb-8 space-y-3">
            <p className="text-xs font-semibold uppercase tracking-[0.32em] text-orange-300/75">High Society, beyond the shop</p>
            <h2 className="text-4xl font-semibold sm:text-5xl">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            {communityCards.map((card) => (
              <Link
                key={card.href}
                href={card.href}
                className="glass-card group relative overflow-hidden rounded-[1.75rem] p-8 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_28px_90px_rgba(255,106,0,.14)]"
              >
                <div className="pointer-events-none absolute -right-16 -top-20 h-44 w-44 rounded-full bg-orange-500/15 blur-[70px] transition group-hover:bg-orange-400/15" />
                <div className="flex h-full flex-col gap-6">
                  <div className="relative flex h-14 w-14 items-center justify-center rounded-2xl bg-white/[.06] text-orange-300 shadow-[inset_0_1px_0_rgba(255,255,255,.1)]">
                    <card.icon className="h-6 w-6" />
                  </div>
                  <div className="space-y-3">
                    <p className="text-sm uppercase tracking-[0.3em] text-orange-300/70">{card.eyebrow}</p>
                  ...
                  <span className="mt-auto inline-flex items-center gap-2 text-sm font-medium text-orange-300 transition-colors group-hover:text-white">
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="glass-panel relative overflow-hidden rounded-[2rem] p-8 lg:p-10">
            <div className="pointer-events-none absolute -left-24 bottom-[-9rem] h-72 w-72 rounded-full bg-amber-400/16 blur-[100px]" />
            <div className="space-y-4">
              <p className="text-xs font-semibold uppercase tracking-[0.32em] text-amber-300/75">Local service</p>
              <h2 className="text-4xl font-semibold sm:text-5xl">
              ...
              <div className="flex flex-wrap items-center gap-3 text-sm text-white/58">
                <span className="inline-flex items-center gap-2">
                  <MapPin className="h-4 w-4 text-orange-300" /> Saint Paul, Minneapolis & nearby metro neighborhoods
                </span>
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8" id="newsletter">
          <div className="glass-panel relative grid gap-8 overflow-hidden rounded-[2rem] p-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center lg:p-12">
            <div className="pointer-events-none absolute -right-28 -top-24 h-80 w-80 rounded-full bg-orange-500/12 blur-[110px]" />
            <div className="pointer-events-none absolute -bottom-24 left-[35%] h-64 w-64 rounded-full bg-orange-400/15 blur-[100px]" />
            <div className="min-w-0 space-y-5">
              <p className="text-xs font-semibold uppercase tracking-[0.32em] text-orange-300/75">Private list</p>
              <h2 className="text-4xl font-semibold sm:text-5xl">
