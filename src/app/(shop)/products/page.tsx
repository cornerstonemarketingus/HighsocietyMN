      ...
      <main>
        <section className="relative overflow-hidden border-b border-white/[.07] bg-black">
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
            <div className="mb-5 flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.24em] text-orange-500">
          ...
          <div className="mb-8 flex flex-col gap-5 rounded-2xl border border-white/[.07] bg-white/[.03] p-4 sm:p-5">
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-2 text-sm font-semibold text-neutral-200">
                <SlidersHorizontal className="h-4 w-4 text-orange-500" /> Browse by category
              </div>
            ...
            <a
              ...
              className={`shrink-0 rounded-full border px-4 py-2 text-sm font-medium transition-colors ${
                !params.category
                  ...
                  : "border-white/10 bg-transparent text-neutral-300 hover:border-orange-500/50 hover:text-orange-400"
              }`}
            >
              All
            </a>
