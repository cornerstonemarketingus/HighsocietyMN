      ...
      <main>
        <section className="relative overflow-hidden border-b-2 border-black bg-white">
          <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
            <div className="mb-5 flex items-center gap-2 text-xs font-bold uppercase tracking-[0.24em] text-green-700">
              <Sparkles className="h-4 w-4" /> The High Society Edit
            </div>
            <h1 className="max-w-3xl text-4xl font-black uppercase tracking-tight text-slate-950 sm:text-6xl">
            {params.category
            ...
            <form action="/products" className="mt-8 flex max-w-xl items-center rounded-full border-2 border-black bg-white p-1.5">
              ...
              />
              <button className="rounded-full bg-green-500 px-5 py-2.5 text-sm font-bold text-black transition hover:bg-green-400">
                Search
              </button>
            </form>
          </div>
        ...
        <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
          <div className="mb-8 flex flex-col gap-5 rounded-2xl border-2 border-black bg-slate-50 p-4 sm:p-5">
            ...
            <a
              href="/products"
              className={`shrink-0 rounded-full border-2 border-black px-4 py-2 text-sm font-bold transition-colors ${
                !params.category
