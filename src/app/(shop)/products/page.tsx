...
export default async function ProductsPage({
  ...
  return (
    <div className="min-h-screen bg-white">
      <Header />
      <main>
        <section className="relative overflow-hidden border-b border-slate-200 bg-gradient-to-br from-white via-emerald-50/50 to-emerald-50">
          <div className="absolute -right-24 -top-24 h-72 w-72 rounded-full bg-emerald-200/40 blur-3xl" />
          <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
            <div className="mb-5 flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.24em] text-emerald-600">
            ...
            <form action="/products" className="mt-8 flex max-w-xl items-center rounded-full border border-slate-200 bg-white p-1.5 shadow-lg shadow-emerald-950/5">
          ...
          <div className="mb-8 flex flex-col gap-5 rounded-3xl border border-slate-200 bg-slate-50/80 p-4 sm:p-5">
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-2 text-sm font-semibold text-slate-800">
                <SlidersHorizontal className="h-4 w-4 text-emerald-600" /> Browse by category
              </div>
        ...
        <Suspense fallback={<div className="text-slate-600">Loading...</div>}>
          {products.length === 0 ? (
            <div className="text-center py-20 space-y-4">
              ...
              <a href="/products" className="text-emerald-400 hover:underline">
                View all products
              </a>
            </div>
          ) : (
