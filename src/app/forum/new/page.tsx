  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-2xl px-4 py-16 sm:px-6">
        <Link
          href="/forum"
          className="inline-flex items-center gap-2 text-slate-600 hover:text-orange-400 text-sm mb-8"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full rounded-md border border-slate-300 bg-slate-50 px-3 py-2 text-sm text-slate-950 focus:outline-none focus:ring-2 focus:ring-orange-500"
            >
              {CATEGORIES.map((cat) => (
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              rows={8}
              maxLength={5000}
              className="w-full rounded-md border border-slate-300 bg-slate-50 px-3 py-2 text-sm text-slate-950 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-orange-500 resize-none"
            />
