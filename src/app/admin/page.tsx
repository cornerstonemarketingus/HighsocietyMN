...
export default async function AdminDashboard() {
  ...
  const cards = [
    { label: "Total Revenue", value: formatPrice(stats.revenue), icon: DollarSign, color: "text-indigo-400" },
            ...
            {recentOrders.map((order) => (
              <div key={order.id} className="p-4 flex items-center justify-between">
                ...
                <div className="text-right">
                  <p className="text-indigo-400 font-medium">{formatPrice(order.total)}</p>
