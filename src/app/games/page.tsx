  ...
  return (
    <div className="aurora-page min-h-screen overflow-hidden text-white">
      ...
      <main className="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="pointer-events-none absolute -left-32 top-24 h-80 w-80 rounded-full bg-amber-400/15 blur-[120px]" />
        <div className="pointer-events-none absolute -right-32 top-80 h-96 w-96 rounded-full bg-orange-500/14 blur-[130px]" />

        <div className="relative mb-9 flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.32em] text-orange-300/75">High Society Arcade</p>
